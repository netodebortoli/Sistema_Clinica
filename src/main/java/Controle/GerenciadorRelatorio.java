...
public class GerenciadorRelatorio {
    ...
    public void criarRelatorio(List lista, String nome) {
        try {
            // PASSO 1 - Caminho do relatório
            InputStream relatorio = getClass().getResourceAsStream("../Relatorio/" + nome);
            ...
            JOptionPane.showMessageDialog(null, "Erro ao abrir relatório.\n" + erro.getMessage());
